...
const propertyDescriptions: Record<string, string> = {
  ...
  allowCustomValue: '允许提交不在选项列表中的自定义值。',
  autoComplete: '设置原生输入框的自动填充行为。',
  autoHighlight: '打开列表时自动高亮首个可用选项。',
  ...
  defaultInputValue: '非受控模式下的初始输入内容。',
  defaultValue: '非受控模式下的初始值。',
  description: '补充说明内容。',
  disabled: '禁用组件及其交互。',
  dropdownClassName: '追加选项浮层的 CSS 类名。',
  emptyText: '覆盖无匹配选项时的提示内容。',
  filterOption: '自定义单个选项的匹配规则。',
  filterOptions: '控制是否在本地过滤选项。',
  icon: '设置组件图标。',
  inputClassName: '追加输入框的 CSS 类名。',
  inputValue: '受控模式下的当前输入内容。',
  ...
  onChange: '值发生变化时触发。',
  onClick: '点击组件时触发。',
  onCreateOption: '提交自定义选项时触发。',
  onInputValueChange: '输入内容发生变化时触发。',
  onOpenChange: '打开状态发生变化时触发。',
  open: '控制浮层或面板是否打开。',
  openOnFocus: '聚焦输入框时自动打开选项列表。',
  optionClassName: '根据选项状态追加 CSS 类名。',
  options: '定义可选择的选项。',
  placeholder: '未选择或未输入时显示的提示。',
  placement: '设置浮层或定位元素的位置。',
  required: '标记表单值为必填。',
  renderOption: '自定义选项内容的渲染方式。',
  searchable: '启用选项搜索。',
  size: '设置组件尺寸。',
  status: '设置组件状态样式。',
  step: '设置数值变化步长。',
...
const englishPropertyDescriptions: Record<string, string> = {
  ...
  allowCustomValue: 'Allows values that are not present in the option list.',
  autoComplete: 'Sets the native input autocomplete behavior.',
  autoHighlight: 'Highlights the first enabled option when the list opens.',
  ...
  clearable: 'Allows the current value to be cleared.',
  ...
  defaultInputValue: 'Sets the initial input text in uncontrolled mode.',
  ...
  dropdownClassName: 'Adds custom CSS class names to the option overlay.',
  emptyText: 'Overrides the content shown when no options match.',
  filterOption: 'Customizes how each option is matched against the query.',
  filterOptions: 'Controls whether options are filtered locally.',
  finalFocusRef: 'References the element that receives focus after the overlay closes.',
  icon: 'Sets the component icon.',
  inputClassName: 'Adds custom CSS class names to the input.',
  inputValue: 'Sets the current input text in controlled mode.',
  invalid: 'Marks the component as having a validation error.',
  ...
  loadingText: 'Overrides the loading-state content.',
  ...
  onCreateOption: 'Called when a custom option is submitted.',
  onInputValueChange: 'Called when the input text changes.',
  ...
  openOnFocus: 'Opens the option list when the input receives focus.',
  optionClassName: 'Adds CSS class names based on the option state.',
  ...
  renderOption: 'Customizes how option content is rendered.',
  role: 'Sets the component accessibility role.',
