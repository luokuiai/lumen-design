...
export const generatedComponentApi: Record<string, GeneratedPropDoc[]> = {
  ...
  Dialog: [
    ...
    },
    {
      ...
      descriptionEn:
        "References the element that receives focus after the overlay opens.",
      required: false,
    },
    {
      name: "finalFocusRef",
      ...
      descriptionEn:
        "References the element that receives focus after the overlay closes.",
      required: false,
    },
    {
      name: "role",
    ...
    },
    {
      ...
      descriptionEn:
        "References the element that provides the accessible name.",
      required: false,
    },
    {
      ...
      descriptionEn:
        "References the element that provides an accessible description.",
      required: false,
    },
  ],
  Textarea: [
  ...
  DropdownMenu: [
    {
      ...
      descriptionEn:
        "Renders the trigger and provides its open state, menu ID, and toggle method.",
      required: true,
    },
    {
      name: "children",
    ...
    },
    {
      ...
      descriptionEn:
        "Sets the delay before the close animation completes, in milliseconds.",
      required: false,
    },
    {
      name: "menuMode",
      ...
      descriptionEn:
        "Enables menu semantics, focus management, and arrow-key navigation.",
      required: false,
    },
    {
      name: "onOpenChange",
  ...
  DatePicker: [
    ...
    },
    {
      ...
      description: "输入框占位提示",
      descriptionEn:
        "Sets the hint shown when no value has been entered or selected.",
      required: false,
    },
    {
  ...
  Drawer: [
    ...
    },
    {
      ...
      descriptionEn:
        "Allows the drawer to close with a swipe gesture on touch devices.",
      required: false,
    },
    {
      name: "lockScroll",
  ...
  TabView: [
    ...
    },
    {
      ...
      type: "string",
      defaultValue:
        "'a, button, input, select, textarea, [contenteditable=\"true\"], [data-tab-view-swipe-ignore]'",
  ...
  Skeleton: [
    ...
    {
      name: "width",
      type: 'import("/home/vincent/SourceCode/Web/lumen-design/node_modules/.bun/csstype@3.2.3/node_modules/csstype/index").Property.Width<string | number>',
      defaultValue: "undefined",
    ...
    {
      name: "height",
      type: 'import("/home/vincent/SourceCode/Web/lumen-design/node_modules/.bun/csstype@3.2.3/node_modules/csstype/index").Property.Height<string | number>',
      defaultValue: "undefined",
  ...
  Badge: [
    ...
    {
      name: "variant",
      type: '"default" | "neutral" | "info" | "success" | "warning" | "danger" | "outline"',
      defaultValue: "'default'",
      description: "设置组件的视觉变体。",
      descriptionEn: "Sets the visual variant of the component.",
      required: false,
  ...
  SwipeActions: [
    ...
    },
    {
      ...
      type: "string",
      defaultValue:
        "'input, select, textarea, [contenteditable=\"true\"], [data-swipe-actions-ignore]'",
