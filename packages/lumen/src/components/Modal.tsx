...
const overlayBaseClassName =
  'fixed inset-0 z-[100] flex items-center justify-center overscroll-contain bg-[var(--lumen-color-overlay)] p-4 backdrop-blur-sm';
  ...
  return createPortal(
    ...
    >
      <div
        data-modal={modalId}
        data-lumen-motion
        className={`${isClosing ? 'animate-[lumen-modal-out_150ms_ease-in_forwards]' : 'animate-[lumen-modal-in_200ms_ease-out]'} ${panelClassName}`.trim()}
